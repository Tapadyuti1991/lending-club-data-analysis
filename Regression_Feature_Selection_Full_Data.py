...
X_train_pearson, X_test_pearson, Y_train_pearson, Y_test_pearson = train_test_split(pearson_df.ix[:, pearson_df.columns != 'int_rate'], pearson_df.int_rate, test_size=0.2)
...
X_train_percentile, X_test_percentile, Y_train_percentile, Y_test_percentile = train_test_split(percentile_df.ix[:, percentile_df.columns != 'int_rate'], percentile_df.int_rate, test_size=0.2)
...
X_train_rfe, X_test_rfe, Y_train_rfe, Y_test_rfe = train_test_split(rfe_df.ix[:, rfe_df.columns != 'int_rate'], rfe_df.int_rate, test_size=0.2)
...
X_train_nn, X_test_nn, Y_train_nn, Y_test_nn = train_test_split(neural_network_df.ix[:, neural_network_df.columns != 'int_rate'], neural_network_df.int_rate, test_size=0.2)
...
X_train_knn, X_test_knn, Y_train_knn, Y_test_knn = train_test_split(knn_df.ix[:, knn_df.columns != 'int_rate'], knn_df.int_rate, test_size=0.2)
...
X_train_random, X_test_random, Y_train_random, Y_test_random = train_test_split(random_df.ix[:, random_df.columns != 'int_rate'], random_df.int_rate, test_size=0.2)
